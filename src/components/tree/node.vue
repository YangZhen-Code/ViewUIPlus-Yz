<template>
    <div>
        <Cell
            :class="{
                'ivu-cell-selected': data.selected,
                [prefixCls + '-level' + data.level]: true,
            }"
...
export default {
    ...
    computed: {
        classes() {
            return [
                `${prefixCls}-children`,
                `${prefixCls}-level${this.data.level}`,
            ];
        },
        selectedCls() {
            return [
    ...
    methods: {
        ...
        handleSelect() {
            ...
            if (
                this.TreeInstance.showCheckbox &&
                this.TreeInstance.checkDirectly
            ) {
                this.handleCheck();
            } else {
